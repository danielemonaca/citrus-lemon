            ...
            {screenWidth > MOBILE_VIEW_THRESHOLD ? (
                    <SecondSectionWrapper>
                        ...
                        <TextWrapper>
                            ...
                            <Text>
                                <strong>CITRUS x LEMON</strong> è una performance collaborativa che vive attraverso diversi
                                media.<br/>
                                Una riflessione su quanto l'essere umano è cosciente della sua ibridità, di essere parte di
                                un sistema, dell'accettazione dei propri limiti e potenzialità umane in collaborazione con
                                l'ambiente che vive.<br/>
                                Cercando di comprendere meglio l' intreccio con la contemporanea realtà "umida", non più
                                quindi binaria: analogica o digitale, organica o inorganica, asciutta o bagnata. Quindi
                                capire come l'uomo vive questo contesto, le multiple realtà che avvengono parallelamente nel
                                virtuale ormai mischiate a una realtà accettata comunemente come "vera", rendendo quasi
                                invisibile il confine tra le diverse realtà.<br/>
                            ...
                            <Text>
                                ...
                                luoghi che preferiscono, diventando così co-autori della performance;<br/>
                                ...
                                dei temi sopra trattati attraverso il simbolico frutto del limone che in questo è cosciente.
                                Ovviamente essendo sparsi in diversi luoghi anche pubblici chiunque può potenzialmente
                                vedere i video;<br/>
                                <strong>Monitoraggio su mappa.</strong> Dopo la visione del video si può accedere a una
                                mappa che indicherà la posizione di ogni piantina piantata e scansionata dagli altri utenti.<br/>
                                <strong>Il corso della natura.</strong> I semi di limone avranno la possibilità di
                                germogliare e crescere in autonomia, anche in posti non predisposti dalla società, per via
                                ...
                                avessero voglia, si ricorda che affinché il limone produca frutti è necessaria una procedura
                                d'innesto.<br/>
                                L'installazione delle piante è iniziata a Ottobre 2020 basato sulla infinita ciclicità della
                                natura non è possibile definire il termine della performance.<br/>
